...
```{r}
forest_plot(malig, "BRCA 2 Malignancies", abbrev)
```

```{r brca1 benign}
forest_plot(benign, "BRCA 2 Benign", .)
```
...
forest_plot(ghs_malig_expand, "BRCA 2 Malignant Expanded", icd10_group_desc)
```

```{r brca1 malignant expanded}
forest_plot(benign_expand, "BRCA 2 Benign Expanded", .)
```