...
ukbb_malig_expand = read_excel('/Users/orszagl2/Documents/Genetics/specific_cancers/ukbb_brca1_malignancies.xlsx', sheet = 2)
ghs_ben_expand = read_excel('/Users/orszagl2/Documents/Genetics/specific_cancers/ghs_brca1_benign.xlsx', sheet = 2)
ukbb_ben_expand <- read_excel('/Users/orszagl2/Documents/Genetics/specific_cancers/ukbb_brca1_benign.xlsx', sheet = 2)
```
...
```
```{r brca 1 malignant}
forest_plot_tab2(malig, "BRCA 1 Malignant")
forest_plot_tab2(malig_expand, "BRCA 1 Malignant Expanded")
```

```{r brca1 benign}
forest_plot_tab2(benign, "BRCA 1 Benign")
forest_plot_tab2(benign_expand, "BRCA 1 Benign Expanded")
```
