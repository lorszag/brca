...
```{r read in files}
brca1_malig <- read_excel('/Users/orszagl2/Documents/Genetics/ukbb_brca1_malignancies.xlsx')
brca2_malig <- read_excel('/Users/orszagl2/Documents/Genetics/ukbb_brca2_malignancies.xlsx')
brca1_ben <- read_excel('/Users/orszagl2/Documents/Genetics/ukbb_brca1_benign.xlsx')
brca2_ben <- read_excel('/Users/orszagl2/Documents/Genetics/ukbb_brca2_benign.xlsx')
map = read_excel('/Users/orszagl2/Documents/Genetics/benign_codes.xlsx')
```
...
```{r filter out 0s}
brca1_ben = brca1_ben%>%filter(ncases!= 0)
brca2_ben = brca2_ben%>%filter(ncases!= 0)
brca1_malig = brca1_malig%>%filter(ncases!= 0)
brca2_malig = brca2_malig%>%filter(ncases!= 0)
```


```{r confidence intervals}
brca1_malig$OR_CI = paste0(round(brca1_malig$OR, 2), "[", round(brca1_malig$lowCI, 2), "-", round(brca1_malig$highCI, 2), "]")
...
forest_plot(brca1_malig, "BRCA 1 Malignancies")
forest_plot_tab(brca1_malig, "BRCA 1 Malignancies")
```

```{r}
forest_plot(brca2_malig, "BRCA 2 Malignancies")
forest_plot_tab(brca2_malig, "BRCA 2 Malignancies")
```
```{r}
