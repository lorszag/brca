...
```{r}
D3 = run_stitch(b_o_cancers, brca1, pheno_female)
...
```{r}
D4 = run_stitch(b_cancers, brca1, pheno_female)
D4_cens = run_stitch_cens(b_cancers, brca1, pheno4)
```
...
D5 = run_stitch(o_cancers, brca1, pheno_female)
